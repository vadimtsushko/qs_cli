...
//
//import 'package:json_rpc_2/src/channel_manager.dart';
//import 'package:json_rpc_2/src/exception.dart';
...
//
//  /// Creates a [SenseClient] that communicates over [channel].
//  ///
//  /// Note that the client won't begin listening to [responses] until
//  /// [SenseClient.listen] is called.
//  SenseClient(StreamChannel<String> channel)
//      : this.withoutJson(channel
//      .transform(jsonDocument)
//      .transformStream(ignoreFormatExceptions));
//
//  /// Creates a [SenseClient] that communicates using decoded messages over
//  /// [channel].
//  ///
...
//  /// Note that the client won't begin listening to [responses] until
//  /// [SenseClient.listen] is called.
//  SenseClient.withoutJson(StreamChannel channel)
...
//  Future sendRequest(String method, int handle, [parameters]) {
//    var id = _id++;
//    _send(method, parameters, id, handle);
//
...
//  void _send(String method, parameters, [int id, int handle]) {
